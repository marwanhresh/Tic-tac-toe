...
playerturn = ttk.Label(root, text="   Player one turn!  ")
playerturn.grid(row=3, column=0, sticky='snew', ipadx=40, ipady=40)


playerdetails = ttk.Label(root, text="    Player one is X\n\n    Player two is O")
playerdetails.grid(row=0, column=3, sticky='snew', ipadx=40, ipady=40)
res = ttk.Button(root, text='Restart')
res.grid(row=3, column=3, sticky='snew', ipadx=40, ipady=40)
...
def ButtonClick(id):
    ...
    if (bu1['text'] == 'X' and bu2['text'] == 'X' and bu3['text'] == 'X' or
        ...
        disableButton()
        c = 1
        tkinter.messagebox.showinfo("Tic Tac Toe", "Winner is player one!!")
        ...
        disableButton()
        c = 1
        tkinter.messagebox.showinfo("Tic Tac Toe", "Winner is player two!!")
    elif b == 9:
        disableButton()
        c = 1
